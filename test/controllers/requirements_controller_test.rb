...
class RequirementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post requirements_url, params: { requirement: { aluno_id: @requirement.aluno_id, banca_id: @requirement.banca_id, dataApresentacao: @requirement.dataApresentacao, documento_id: @requirement.documento_id, nota: @requirement.nota, orientador_id: @requirement.orientador_id, status: @requirement.status, type: @requirement.type } }
    end
  ...
  test "should update requirement" do
    patch requirement_url(@requirement), params: { requirement: { aluno_id: @requirement.aluno_id, banca_id: @requirement.banca_id, dataApresentacao: @requirement.dataApresentacao, documento_id: @requirement.documento_id, nota: @requirement.nota, orientador_id: @requirement.orientador_id, status: @requirement.status, type: @requirement.type } }
